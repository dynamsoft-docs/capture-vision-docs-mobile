...
title: Getting Started with Barcode Reader - Dynamsoft Capture Vision Xamarin.Forms Edition
...
>- You can request a 30-day offline trial license via the [Request a Trial License](https://www.dynamsoft.com/customer/license/trialLicense?product=dbr&utm_source=guide&package=xamarin&version=9){:target="_blank"} link.
