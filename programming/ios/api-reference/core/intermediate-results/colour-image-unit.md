...
title: DSColourImageUnit - Dynamsoft Capture Vision iOS Edition API Reference
description: The class DSColourImageUnit of Dynamsoft Capture Vision iOS represents a unit that contains a colour image.
