...
title: DSBinaryImageUnit - Dynamsoft Capture Vision iOS Edition API Reference
description: The class DSBinaryImageUnit of Dynamsoft Capture Vision iOS represents a unit that contains a binary image.
