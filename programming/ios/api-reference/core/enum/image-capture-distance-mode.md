...
title: ImageCaptureDistanceMode - Dynamsoft Capture Vision iOS Enumerations
description: The enumeration ImageCaptureDistanceMode of Dynamsoft Capture Vision iOS is used to distinguish the close-up images from the prospect images.
